                  ...
                  <form:form method="post" action="/admin/product/create" modelAttribute="newProduct" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      ...
                      <div class="mb-3 col-md-6 col-12">
                        ...
                        <form:input type="number" class="form-control ${not empty errorName? 'is-invalid' : ''}" path="price" />
                        ${errorPrice}
                      </div>
                      <div class="mb-3 col-12">
                        <label class="form-label">Detail description:</label>
                        <form:textarea type="text" class="form-control form-control-lg ${not empty errorName? 'is-invalid' : ''}" path="detailDesc" />
                        ${errorDetailDesc}
                      </div>
                      <div class="mb-3 col-md-6 col-12">
                        <label class="form-label">Short description:</label>
                        <form:input type="text" class="form-control ${not empty errorName? 'is-invalid' : ''}" path="shortDesc" />
                        ${errorShortDesc}
                      </div>
                      <div class="mb-3 col-md-6 col-12">
                        <label class="form-label">Quantity:</label>
                        <form:input type="number" class="form-control ${not empty errorName? 'is-invalid' : ''}" path="quantity" />
                        ${errorQuantity}
                      </div>
                      <div class="mb-3 col-md-6 col-12">
